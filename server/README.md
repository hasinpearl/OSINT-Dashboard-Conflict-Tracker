...
React 18, TypeScript, Vite, Tailwind CSS, Node (Hono) API, PostgreSQL, OpenRouter (Perplexity Sonar models), and open-source web scraping tools.
...
- **Open-source web scraping**: Uses @mozilla/readability and jsdom for content extraction, with Wayback Machine fallback for blocked sites
