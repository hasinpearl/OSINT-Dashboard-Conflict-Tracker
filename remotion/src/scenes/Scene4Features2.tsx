...
const features = [
  { icon: "✅", text: "قسم يظهر الانحياز الإعلامي لأكثر الأخبار تداولاً" },
  { icon: "✅", text: "نتائج دقيقة وليست عشوائية مع تلقائية عبر الذكاء الاصطناعي" },
  { icon: "✅", text: "يمكن تكبير وتصغير أي قسم للتركيز عليه" },
];
...
export const Scene4Features2 = () => {
  ...
  return (
    ...
    >
      ...
      >
        Intelligence & Precision — الدقة والذكاء
      </div>
